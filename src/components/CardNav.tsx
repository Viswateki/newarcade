      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] pr-[1.1rem] z-[2]">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <span className="logo text-xl md:text-2xl font-bold tracking-tight">
              <span style={{ color: "#00bcd4" }}>ai</span>
              <span style={{ color: menuColor || "#000" }}>arcade</span>
            </span>
          </div>

          {/* Show Sign In button only for non-authenticated users */}
          {!user && (
            <div className="flex items-center">
              <a
                ...
                style={{ 
                  backgroundColor: buttonBgColor || '#374151',
