...
const DashboardMagicBento: React.FC<DashboardBentoProps> = ({
  textAutoHide = true,
  enableStars = true,
  ...
  // Create dashboard cards with real data
  const dashboardCards = [
    {
      color: colors.card,
      title: 'Total Blogs',
      description: `${stats.blogs} published articles`,
      label: 'Content',
      icon: FaBlog,
      value: stats.blogs,
    ...
    },
    {
      color: colors.card,
      title: 'Total Views',
      description: `${stats.views.toLocaleString()} page views`,
      label: 'Analytics',
      icon: FaEye,
      value: stats.views,
    ...
    },
    {
      color: colors.card,
      title: 'Total Likes',
      description: `${stats.likes} likes received`,
      label: 'Engagement',
      icon: FaThumbsUp,
      value: stats.likes,
    ...
    },
    {
      ...
      description: userBlogs.length > 0 ? `Latest: ${userBlogs[0]?.title?.substring(0, 30)}...` : 'No recent activity',
      label: 'Activity',
      icon: FaClock,
            ...
            const cardContent = (
              <>
                <div className="card__header flex justify-between gap-3 relative">
                  <span className="card__label text-base font-medium" style={{ color: colors.accent }}>
                    {card.label}
                  </span>
