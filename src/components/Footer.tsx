      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="justify-between items-center gap-12 md:flex">
          <div className="flex-1 max-w-lg">
            ...
            >
              Stay updated with the latest tools, tutorials, and community insights.
            </p>
          </div>
          <div className="flex-1 mt-6 md:mt-0">
            ...
            >
              <div className="relative">
                <svg
                  className="w-6 h-6 absolute left-3 inset-y-0 my-auto transition-colors duration-300"
                  style={{ color: theme === 'dark' ? '#9ca3af' : '#6b7280' }}
                ...
                <input
                  ...
                  className="w-full pl-12 pr-3 py-2 outline-none border shadow-sm rounded-lg transition-colors duration-300"
                  style={{
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = theme === 'dark' ? '#00a8b8' : '#0097a7';
                }}
                onMouseLeave={(e) => {
        ...
        <div 
          className="mt-10 py-10 items-center justify-between sm:flex"
          style={{ borderTop: `1px solid ${colors.border}` }}
        >
          <p style={{ color: theme === 'dark' ? '#9ca3af' : '#6b7280' }}>
            © {currentYear} AI Arcade. All rights reserved.
          </p>
