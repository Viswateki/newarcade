    ...
    if (isMobile) {
      return (
        ...
        >
          ...
          />
          <div className="fixed left-0 top-0 h-full w-[--sidebar-width-mobile] bg-sidebar text-sidebar-foreground border-r">
...
>(
  (
    ...
    const baseClasses = cn(
      ...
      {
        "bg-sidebar-accent font-medium text-sidebar-accent-foreground": isActive,
