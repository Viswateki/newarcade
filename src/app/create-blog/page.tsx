...
export default function CreateBlogPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    featured: false,
    featured_image: '',
    image: '', // Adding the image field that exists in your collection
    seo_description: ''
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const blogData = {
        ...
        views: 0,
        likes: 0,
        // Add slug (will be generated in service if not provided)
        slug: formData.title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')
        // Note: $createdAt and $updatedAt are auto-generated by Appwrite
      };
